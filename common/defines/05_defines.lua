-- Force a checksum change by editing this line.
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- Game
...
NDefines.NNavy.DOMINANCE_DAILY_GAIN_FACTOR = 0.02 									-- Daily dominance gain, as a fraction of target value
...
NDefines.NNavy.ANTI_AIR_ATTACK_TO_AMOUNT = 0.001 									-- Balancing value to convert equipment stat anti_air_attack to the random % value of airplanes being hit. Was 0.004
...
NDefines.NNavy.DOMINANCE_PER_SHIP_PER_RANGE_NEUTRAL = 3500							-- ship range where there is no penalty nor bonus to naval dominance, below or above this will be scaled accordingly with penalty or bonus, min value is 0
...
NDefines.NNavy.DOMINANCE_PER_SHIP_PER_HEAVY_GUN_ATTACK = 0.008						-- bonus to dominance based on the heavy attack, min value is 0
...
NDefines.NAI.CANCEL_COMBAT_MIN_DURATION_HOURS = 24              					-- Only allow cancelling (normal) combat if at least <value> hours have passed
...
NDefines.NAI.ENEMY_NAVY_STRENGTH_DONT_BOTHER = 5.0
...
NDefines.NAI.CONSTRUCTION_PRIO_INFRASTRUCTURE = 1.00                                -- base prio for infrastructure in the construction queue
NDefines.NAI.CONSTRUCTION_PRIO_CIV_FACTORY = 1.00                                  	-- base prio for civilian factories in the construction queue
NDefines.NAI.CONSTRUCTION_PRIO_MIL_FACTORY = 1.00                                   -- base prio for military factories in the construction queue
NDefines.NAI.CONSTRUCTION_PRIO_RAILWAY = 1.00                                       -- base prio for railways in the construction queue
NDefines.NAI.CONSTRUCTION_PRIO_RAILWAY_GUN_REPAIR = 15.00                           -- base prio for railway gun repairs in the construction queue
NDefines.NAI.CONSTRUCTION_PRIO_UNSPECIFIED = 1.00                                   -- base prio for unspecified buildings (none of the categories above) in the construction queue
...
NDefines.NDoctrines.TRAINING_MASTERY_GAIN_FACTOR = 0.03									-- How much training contributes to doctrine mastery relative to combat/missions
