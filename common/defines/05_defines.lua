...
NDefines.NMilitary.SUPPLY_GRACE = 240												-- troops always carry 28 days of food and supply
...
NDefines.NProduction.EQUIPMENT_MODULE_ADD_XP_COST = 8.0							-- XP cost for adding a new equipment module in an empty slot when creating an equipment variant.
NDefines.NProduction.EQUIPMENT_MODULE_REPLACE_XP_COST = 8.0						-- XP cost for replacing one equipment module with an unrelated module when creating an equipment variant.
...
NDefines.NNavy.NAVAL_COMBAT_AIR_SUB_DETECTION_MAX = 10
NDefines.NNavy.NAVAL_COMBAT_AIR_PLANE_COUNT_TO_SUB_DETECTION = 0.1					-- Factor applied to the number of active plane in a naval combat to deduce their contribution to sub detection
...
NDefines.NAI.LAND_COMBAT_ANTI_LOGISTICS_PER_ENEMY_ARMY = 2     						-- Amount of CAS planes requested per enemy army for anti-logistics
