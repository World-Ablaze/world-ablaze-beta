...
NDefines.NProduction.MIN_LAND_EQUIPMENT_CONVERSION_IC_COST_FACTOR = 5				-- Fraction of the chassis industry cost which is always included in the conversion cost.
