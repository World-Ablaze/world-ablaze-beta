...
NDefines.NBuildings.RADAR_RANGE_BASE = 12											-- Radar range base, first level radar will be this + min, best radar will be this + max
NDefines.NBuildings.RADAR_RANGE_MIN = 12												-- Radar range (from state center to province center) in measure of map pixels. Exluding techs.
