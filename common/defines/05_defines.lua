...
NDefines.NAI.DIVISION_SUPPLY_RATIO_TO_MOTORIZE = 0.9								-- If supply ratio is less than this, consider motorizing any applicable nearby supply hub
...
NDefines.NAI.LAND_COMBAT_CAS_PER_COMBAT = 270										-- Amount of CAS requested per combat, 90cw x 3 cas per cw
