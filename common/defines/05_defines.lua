...
NDefines.NIndustrialOrganisation.FUNDS_FROM_MANUFACTURER_PER_IC_PER_DAY = 0.3			-- Funds added to MIO when a manufacturer is attached to a production line. Added every day proportional to IC produced.
