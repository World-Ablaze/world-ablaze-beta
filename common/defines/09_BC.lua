...
NDefines_Graphics.NAirGfx.BOMBERS_DIVISION_FACTOR = 600					-- Number of effective bombers in a strategic region will be divided by this factor.
NDefines_Graphics.NAirGfx.MISSILES_DIVISION_FACTOR = 600					-- Number of missiles shown in a strategic region will be divided by this factor.
NDefines_Graphics.NAirGfx.FIGHTERS_DIVISION_FACTOR = 600					-- Number of missiles shown in a strategic region will be divided by this factor.
NDefines_Graphics.NAirGfx.SCOUT_PLANE_DIVISION_FACTOR = 600				-- Number of missiles shown in a strategic region will be divided by this factor.