...
NDefines_Graphics.BOMBERS_DIVISION_FACTOR = 600					-- Number of effective bombers in a strategic region will be divided by this factor.
NDefines_Graphics.MISSILES_DIVISION_FACTOR = 600					-- Number of missiles shown in a strategic region will be divided by this factor.
NDefines_Graphics.FIGHTERS_DIVISION_FACTOR = 600					-- Number of missiles shown in a strategic region will be divided by this factor.
NDefines_Graphics.SCOUT_PLANE_DIVISION_FACTOR = 600				-- Number of missiles shown in a strategic region will be divided by this factor.