<!-- WA-SYNC: vendored copy of the engine's own special projects documentation.
WA-SYNC: source   = <HOI4 install>/common/special_projects/projects/documentation.md
...
WA-SYNC: The previous copy was identical apart from a WA unit rename inside an example
WA-SYNC: (`motorized` -> `infantry_heavy_motorized_battalion_line`, commit abd3a3c9b) that this sync discards.
-->
