...
- **Mediterranean chain (blocked):** R9 (supply lines — fix pending) blocks R13 (NA front) and degrades R17 (Italy); do not re-diagnose downstream items while R9 is unfixed.
