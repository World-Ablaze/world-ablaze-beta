...
- **Evidence:** Fix of 2026-08-09; prior partial fixes in commits a9c0407ee "fix engineer names" and 0e3976eca (templates 2-11 hardcoded `engineer_mot_battalion_divisional` correctly, but the four `[SUPPORT_MOT]`-based blocks were missed). All 47 expanded unit names in the 11 spawn templates now verified to exist in `common/units/`.
