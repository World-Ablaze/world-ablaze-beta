...
| Equipment | Three sub-tabs — Army (infantry, artillery, anti-tank, anti-air, motorized, mechanized), Tanks (chassis families) and Air (airframes): signed stockpiles, deployed equipment and recorded reinforcement requests (land), aircraft in wings and stock by role (air), assigned factories; variants and raw production-line fields |
